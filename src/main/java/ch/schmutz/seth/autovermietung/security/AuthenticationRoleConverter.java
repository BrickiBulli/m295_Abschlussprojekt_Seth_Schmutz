package ch.schmutz.seth.autovermietung.security;
...
public class AuthenticationRoleConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    private static Collection<? extends GrantedAuthority> extractResourceRoles(final Jwt jwt) {
        ...
        if (resourceAccess != null) {
            Map<String, Collection<String>> absschlussaufgabeClient = (Map<String, Collection<String>>) resourceAccess.get("AbsschlussaufgabeClient");
          if ((resourceRoles = absschlussaufgabeClient.get("roles")) != null) {
